            ...
            >
              ...
              >
                {category.skills.map((skill) => (
                  <motion.span
                    key={skill}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-secondary/50 hover:bg-secondary text-foreground border border-border rounded-full text-sm font-medium"
