    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Software Engineer exploring AI/ML
          </motion.p>
          ...
          >
            Building intelligent solutions with cutting-edge AI and machine learning
            technologies. Passionate about creating impactful applications that solve real-world problems.
          </motion.p>
